...
import com.acme.iot.platform.shared.interfaces.rest.resources.ErrorResource;
...
public final class ErrorResponseAssembler {
    ...
    private static String toSpecificMessageKeyFromErrorCode(String errorCode) {
        return "error.%s.message".formatted(errorCode.toUpperCase(Locale.ROOT).replace('_', '-'));
    }
